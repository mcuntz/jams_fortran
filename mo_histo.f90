...
CONTAINS
  ...
  SUBROUTINE histo_dp_1d(x, binx, bincount, width, mask, bins, binwidth)
    ...
    do i=1,k
       binx(i) = minimalvalue + real(2*i-1,dp)/2.0_dp*w
       bincount(i) = 0_i4
    end do
  ...
  SUBROUTINE histo_sp_1d(x, binx, bincount, width, mask, bins, binwidth)
    ...
    do i=1,k
       binx(i) = minimalvalue + real(2*i-1,sp)/2.0_sp*w
       bincount(i) = 0_i4
    end do
  ...
  SUBROUTINE histo_dp_2d(x, binx, bincount, width, mask, bins, binwidth)
    ...
    bincount = 0_i4
    do i=1,k
       binx(i,1) = minimalvalue + real(2*i-1,dp)/2.0_dp*w
    end do
  ...
  SUBROUTINE histo_sp_2d(x, binx, bincount, width, mask, bins, binwidth)
    ...
    bincount = 0_i4
    do i=1,k
       binx(i,1) = minimalvalue + real(2*i-1,sp)/2.0_sp*w
    end do
