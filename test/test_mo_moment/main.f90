PROGRAM main
  ...
  isgood = isgood .and. (nint(10._dp*mean(dat1,                  mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 50)
  isgood = isgood .and. (nint(10._dp*average(dat1,               mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 50)
  isgood = isgood .and. (nint(10._dp*variance(dat1,              mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 75)
  isgood = isgood .and. (nint(10._dp*stddev(dat1,                mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 27)
  isgood = isgood .and. (nint(10._dp*skewness(dat1,              mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 00)
  isgood = isgood .and. (nint(10._dp*kurtosis(dat1,              mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == -16)
  isgood = isgood .and. (nint(10._dp*absdev(dat1,                mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 22)
  isgood = isgood .and. (nint(10._dp*central_moment(dat1, 2,     mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 67)
  isgood = isgood .and. (nint(10._dp*central_moment_var(dat1, 2, mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)))) == 38)
  ! Test moment
  call moment(dat1, average=a_dp, variance=v_dp, skewness=s_dp, kurtosis=k_dp, mean=m_dp, &
       stddev=std_dp, absdev=ad_dp, mask=(abs(dat1 - 10._dp) .gt. tiny(1.0_dp)) )
  ...
  isgood = isgood .and. (nint(10._dp*correlation(dat1,dat2, &
       mask=((abs(dat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(dat2 - 10._dp) .gt. tiny(1.0_dp))))) == 9)
  isgood = isgood .and. (nint(10._dp*covariance(dat1,dat2, &
       mask=((abs(dat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(dat2 - 10._dp) .gt. tiny(1.0_dp))))) == 115)
  isgood = isgood .and. (nint(10._dp*mixed_central_moment(dat1,dat2,1,1, &
       mask=((abs(dat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(dat2 - 10._dp) .gt. tiny(1.0_dp))))) == 115)
  isgood = isgood .and. (nint(10._dp*mixed_central_moment_var(dat1,dat2,1,1, &
       mask=((abs(dat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(dat2 - 10._dp) .gt. tiny(1.0_dp))))) == 113)
  ...
  isgood = isgood .and. (nint(10._sp*mean(sat1,                  mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 50)
  isgood = isgood .and. (nint(10._sp*average(sat1,               mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 50)
  isgood = isgood .and. (nint(10._sp*variance(sat1,              mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 75)
  isgood = isgood .and. (nint(10._sp*stddev(sat1,                mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 27)
  isgood = isgood .and. (nint(10._sp*skewness(sat1,              mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 00)
  isgood = isgood .and. (nint(10._sp*kurtosis(sat1,              mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == -16)
  isgood = isgood .and. (nint(10._sp*absdev(sat1,                mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 22)
  isgood = isgood .and. (nint(10._sp*central_moment(sat1, 2,     mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 67)
  isgood = isgood .and. (nint(10._sp*central_moment_var(sat1, 2, mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))) == 38)
  ! Test moment
  call moment(sat1, average=a_sp, variance=v_sp, skewness=s_sp, kurtosis=k_sp, mean=m_sp, &
       stddev=std_sp, absdev=ad_sp, mask=(abs(sat1 - 10._dp) .gt. tiny(1.0_dp)))
  ...
  isgood = isgood .and. (nint(10._sp*correlation(sat1,sat2, &
       mask=((abs(sat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(sat2 - 10._dp) .gt. tiny(1.0_dp))))) == 9)
  isgood = isgood .and. (nint(10._sp*covariance(sat1,sat2, &
       mask=((abs(sat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(sat2 - 10._dp) .gt. tiny(1.0_dp))))) == 115)
  isgood = isgood .and. (nint(10._sp*mixed_central_moment(sat1,sat2,1,1, &
       mask=((abs(sat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(sat2 - 10._dp) .gt. tiny(1.0_dp))))) == 115)
  isgood = isgood .and. (nint(10._sp*mixed_central_moment_var(sat1,sat2,1,1, &
       mask=((abs(sat1 - 10._dp) .gt. tiny(1.0_dp)).and.(abs(sat2 - 10._dp) .gt. tiny(1.0_dp))))) == 113)
