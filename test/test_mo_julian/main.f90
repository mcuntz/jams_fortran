PROGRAM main
  ...
  USE mo_julian, ONLY: caldat360, julday360, date2dec360, dec2date360
  USE mo_julian, ONLY: caldat365, julday365, date2dec365, dec2date365
  ...
  do jj=0, 792000 ! 01.01.2200
     call caldat360(jj,dd,mm,yy)
     ss = julday360(dd,mm,yy)
     if (jj /= ss) isgood = .false.
  end do
  if (julday360(01,01,1900) /= 684000) isgood = .false.
  call caldat360(684000, dd, mm, yy)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900)) isgood = .false.

  ! date2dec360
  if (abs(date2dec360(01,01,1900,12,0)-684000.0_dp) > epsilon(1.0_dp)*684000.0_dp*10.0_dp) isgood = .false.
  if (abs(date2dec360(01,01,1900)-683999.5_dp) > epsilon(1.0_dp)*683999._dp*10.0_dp) isgood = .false.

  ! date2dec360, dec2date360 - scalar
  do jj=1, 109573 ! 01.01.2200
     call random_number(ff)
     rr = real(jj) + ff
     call dec2date360(rr,dd,mm,yy,hh,nn,ss)
     gg = date2dec360(dd,mm,yy,hh,nn,ss)
     call dec2date360(gg,dd2,mm2,yy2,hh2,nn2,ss2)
     if ((dd /= dd2) .or. (mm /= mm2) .or. (yy /= yy2) .or. (hh /= hh2) .or. (nn /= nn2) .or. (ss /= ss2)) isgood = .false.
  end do

  call dec2date360(date2dec360(01,01,1900,12,01,02), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 12) .or. (nn /= 01) .or. (ss /= 02)) isgood = .false.
  call dec2date360(date2dec360(01,01,1900), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 00) .or. (nn /= 00) .or. (ss /= 00)) isgood = .false.
  call dec2date360(date2dec360(01,01,1900,23,59,59), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 23) .or. (nn /= 59) .or. (ss /= 59)) isgood = .false.
  call dec2date360(date2dec360(01,01,01,12,12,12), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 01) .or. (hh /= 12) .or. (nn /= 12) .or. (ss /= 12)) isgood = .false.
  call dec2date360(date2dec360(01,02,-100,11,11,11), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 2) .or. (yy /= -100) .or. (hh /= 11) .or. (nn /= 11) .or. (ss /= 11)) isgood = .false.
  ...
  do jj=1, 2524594 ! 01.01.2200
     call random_number(ff1)
     rr1 = real(jj) + ff1
     call dec2date360(rr1,dd1,mm1,yy1,hh1,nn1,ss1)
     gg1 = date2dec360(dd1,mm1,yy1,hh1,nn1,ss1)
     call dec2date360(gg1,dd12,mm12,yy12,hh12,nn12,ss12)
     if (any(dd1 /= dd12) .or. any(mm1 /= mm12) .or. any(yy1 /= yy12) .or. &
          any(hh1 /= hh12) .or. any(nn1 /= nn12) .or. any(ss1 /= ss12)) isgood = .false.
  end do
  call dec2date360(date2dec360((/01,10,27/),(/02,12,03/),(/-100,1,2000/),(/11,23,00/),(/11,57,47/),(/11,12,59/)), &
       dd1, mm1, yy1, hh1, nn1, ss1)
  if ((dd1(1) /= 1) .or. (mm1(1) /= 2) .or. (yy1(1) /= -100) .or. &
       (hh1(1) /= 11) .or. (nn1(1) /= 11) .or. (ss1(1) /= 11)) isgood = .false.
  if ((dd1(2) /= 10) .or. (mm1(2) /= 12) .or. (yy1(2) /= 1) .or. &
  ...
  do jj=1, 2524594 ! 01.01.2200
     ...
     rr1 = real(jj) + ff1
     call dec2date360(rr1,dd1,mm1,yy1,hh1,nn1,ss1)
     gg1 = date2dec360(dd1(1),mm1(1),yy1(1),hh1,nn1,ss1)
     call dec2date360(gg1,dd12,mm12,yy12,hh12,nn12,ss12)
     if (any(dd1(1) /= dd12) .or. any(mm1(1) /= mm12) .or. any(yy1(1) /= yy12) .or. &
          any(hh1 /= hh12) .or. any(nn1 /= nn12) .or. any(ss1 /= ss12)) isgood = .false.
  end do
  dec1 = date2dec360(01,12,2000,(/11,12,13/),11,59)
  call dec2date360(dec1, dd1, mm1, yy1, hh1, nn1, ss1)
  if ((dd1(1) /= 1) .or. (mm1(1) /= 12) .or. (yy1(1) /= 2000) .or. &
       (hh1(1) /= 11) .or. (nn1(1) /= 11) .or. (ss1(1) /= 59)) isgood = .false.
  if ((dd1(2) /= 1) .or. (mm1(2) /= 12) .or. (yy1(2) /= 2000) .or. &
       (hh1(2) /= 12) .or. (nn1(2) /= 11) .or. (ss1(2) /= 59)) isgood = .false.
  ...
  do jj=1, 79200 ! 01.01.2200
     call caldat360(jj,dd,mm,yy)
     ss = int(date2dec360(dd,mm,yy,12,0,0), i4)
     if (jj /= ss) isgood = .false.
  end do
  ...
  do jj=0, 803000 ! 01.01.2200
     call caldat365(jj,dd,mm,yy)
     ss = julday365(dd,mm,yy)
     if (jj /= ss) isgood = .false.
  end do
  if (julday365(01,01,1900) /= 693500) isgood = .false.
  call caldat365(693500, dd, mm, yy)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900)) isgood = .false.


  ! date2dec365
  if (abs(date2dec365(01,01,1900,12,0)-693500.0_dp) > epsilon(1.0_dp)*693500.0_dp*10.0_dp) isgood = .false.
  if (abs(date2dec365(01,01,1900)-693499.5_dp) > epsilon(1.0_dp)*693499._dp*10.0_dp) isgood = .false.

  ! date2dec365, dec2date365 - scalar
  do jj=1, 803000 ! 01.01.2200
     call random_number(ff)
     rr = real(jj) + ff
     call dec2date365(rr,dd,mm,yy,hh,nn,ss)
     gg = date2dec365(dd,mm,yy,hh,nn,ss)
     call dec2date365(gg,dd2,mm2,yy2,hh2,nn2,ss2)
     if ((dd /= dd2) .or. (mm /= mm2) .or. (yy /= yy2) .or. (hh /= hh2) .or. (nn /= nn2) .or. (ss /= ss2)) isgood = .false.
  end do

  call dec2date365(date2dec365(01,01,1900,12,01,02), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 12) .or. (nn /= 01) .or. (ss /= 02)) isgood = .false.
  call dec2date365(date2dec365(01,01,1900), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 00) .or. (nn /= 00) .or. (ss /= 00)) isgood = .false.
  call dec2date365(date2dec365(01,01,1900,23,59,59), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 1900) .or. (hh /= 23) .or. (nn /= 59) .or. (ss /= 59)) isgood = .false.
  call dec2date365(date2dec365(01,01,01,12,12,12), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 1) .or. (yy /= 01) .or. (hh /= 12) .or. (nn /= 12) .or. (ss /= 12)) isgood = .false.
  call dec2date365(date2dec365(01,02,-100,11,11,11), dd, mm, yy, hh, nn, ss)
  if ((dd /= 1) .or. (mm /= 2) .or. (yy /= -100) .or. (hh /= 11) .or. (nn /= 11) .or. (ss /= 11)) isgood = .false.
  ...
  do jj=1, 803000 ! 01.01.2200
     call random_number(ff1)
     rr1 = real(jj) + ff1
     call dec2date365(rr1,dd1,mm1,yy1,hh1,nn1,ss1)
     gg1 = date2dec365(dd1,mm1,yy1,hh1,nn1,ss1)
     call dec2date365(gg1,dd12,mm12,yy12,hh12,nn12,ss12)
     if (any(dd1 /= dd12) .or. any(mm1 /= mm12) .or. any(yy1 /= yy12) .or. &
          any(hh1 /= hh12) .or. any(nn1 /= nn12) .or. any(ss1 /= ss12)) isgood = .false.
  end do

  call dec2date365(date2dec365((/01,10,27/),(/02,12,03/),(/-100,1,2000/),(/11,23,00/),(/11,57,47/),(/11,12,59/)), &
       dd1, mm1, yy1, hh1, nn1, ss1)
  if ((dd1(1) /= 1) .or. (mm1(1) /= 2) .or. (yy1(1) /= -100) .or. &
       (hh1(1) /= 11) .or. (nn1(1) /= 11) .or. (ss1(1) /= 11)) isgood = .false.
  if ((dd1(2) /= 10) .or. (mm1(2) /= 12) .or. (yy1(2) /= 1) .or. &
  ...
  do jj=1, 803000 ! 01.01.2200
     ...
     rr1 = real(jj) + ff1
     call dec2date365(rr1,dd1,mm1,yy1,hh1,nn1,ss1)
     gg1 = date2dec365(dd1(1),mm1(1),yy1(1),hh1,nn1,ss1)
     call dec2date365(gg1,dd12,mm12,yy12,hh12,nn12,ss12)
     if (any(dd1(1) /= dd12) .or. any(mm1(1) /= mm12) .or. any(yy1(1) /= yy12) .or. &
          any(hh1 /= hh12) .or. any(nn1 /= nn12) .or. any(ss1 /= ss12)) isgood = .false.
  end do
  dec1 = date2dec365(01,12,2000,(/11,12,13/),11,59)
  call dec2date365(dec1, dd1, mm1, yy1, hh1, nn1, ss1)
  if ((dd1(1) /= 1) .or. (mm1(1) /= 12) .or. (yy1(1) /= 2000) .or. &
       (hh1(1) /= 11) .or. (nn1(1) /= 11) .or. (ss1(1) /= 59)) isgood = .false.
  if ((dd1(2) /= 1) .or. (mm1(2) /= 12) .or. (yy1(2) /= 2000) .or. &
       (hh1(2) /= 12) .or. (nn1(2) /= 11) .or. (ss1(2) /= 59)) isgood = .false.
  ...
  do jj=1, 803000 ! 01.01.2200
     call caldat365(jj,dd,mm,yy)
     ss = int(date2dec365(dd,mm,yy,12,0,0), i4)
     if (jj /= ss) isgood = .false.
  end do
